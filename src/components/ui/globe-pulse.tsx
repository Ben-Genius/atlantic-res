...
export function GlobePulse({
  ...
  useEffect(() => {
    ...
    const initialLocation = markers.length > 0 ? markers[0].location : [0, 0]
    let phi = 4.7123 - (initialLocation[1] * Math.PI) / 180
    let thetaBase = (initialLocation[0] * Math.PI) / 180
    ...
    function animate() {
      ...
      globe!.update({
        ...
        theta: thetaBase + thetaOffsetRef.current + dragOffset.current.theta,
      })
