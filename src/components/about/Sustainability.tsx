    ...
    <section className="scroll-reveal w-full px-6 md:px-16 py-8 ">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        <div className="lg:col-span-5">
          <span className="block font-inter text-[#3C8B36] text-xs font-bold uppercase tracking-[0.3em] mb-4">
            Sustainability
          </span>
          <span
            className="block font-black uppercase leading-none text-[12vw] lg:text-[5rem] text-transparent"
            style={{ WebkitTextStroke: '1.5px rgba(27,67,50,0.30)' }}
            aria-hidden
          >
            DOING
          </span>
          <span className="block font-black uppercase leading-none text-[12vw] lg:text-[5rem] text-[#0d0d0d] -mt-1">
            BUSINESS
          </span>
          <span className="block font-black uppercase leading-none text-[12vw] lg:text-[5rem] text-[#3C8B36] -mt-1">
            RIGHT.
          </span>
          <p className="font-inter text-[#0d0d0d]/70 text-sm leading-relaxed mt-6">
        ...
        <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-0 border border-black/10">
          {SDGS.map((sdg, idx) => (
            <div
              key={idx}
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="font-black text-sm uppercase tracking-tight text-[#0d0d0d]">{sdg.title}</span>
              </div>
              <p className="font-inter text-[#0d0d0d]/65 text-xs leading-relaxed">{sdg.desc}</p>
            </div>
          ))}
        </div>
      </div>
