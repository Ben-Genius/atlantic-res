...
import CutleryPattern from '@/components/ui/CutleryPattern'
import AgilityOfALocalActor from '@/components/sustainability/AgilityOfALocalActor'
...
export default function SustainabilityPage() {
  ...
  useGSAP(() => {
    ...
    gsap.fromTo('.gsap-hero-dish-left', { x: -100, rotate: -30, opacity: 0 }, { x: 0, rotate: 0, opacity: 1, duration: 1.5, delay: 0.2, ease: 'power2.out' })
    gsap.fromTo('.gsap-hero-dish-right', { x: 100, rotate: 30, opacity: 0 }, { x: 0, rotate: 0, opacity: 1, duration: 1.5, delay: 0.3, ease: 'power2.out' })
  ...
  /* =================================================================
     ...
     8: Closing Promise
     ================================================================= */
  /* One type scale for every left panel. Outfit throughout, a single ink
     ramp, and one size per role — the panels previously mixed Outfit with
     the default sans and ran headings at 3.2rem / 4xl / 5xl side by side. */
  const T = {
    eyebrow: 'block font-outfit text-xs font-semibold uppercase tracking-[0.3em]',
    heading: 'font-outfit text-3xl xl:text-[2.75rem] font-semibold text-[#1a1a1a] tracking-tight leading-[1.08] mt-6',
    lead: 'font-outfit text-xl xl:text-[1.5rem] font-normal text-[#1a1a1a]/85 leading-relaxed max-w-2xl',
    subhead: 'font-outfit text-lg font-semibold text-[#1a1a1a] leading-snug',
    body: 'font-outfit text-sm text-[#1a1a1a]/70 leading-relaxed',
    meta: 'font-outfit text-xs text-[#1a1a1a]/55 leading-relaxed',
    statValue: 'font-outfit text-lg xl:text-2xl font-semibold text-[#1a1a1a] tracking-tight',
    statLabel: 'font-outfit text-[10px] font-medium uppercase tracking-[0.13em] text-[#1a1a1a]/45 mt-1.5',
  }
  ...
  const leftPanels = [
    ...
    <div key="p0" className="w-full shrink-0 flex flex-col justify-center px-14 xl:px-20 py-16" style={{ height: panelHeight, background: pillars[0].theme.tint }}>
      <span className={T.eyebrow} style={{ color: pillars[0].theme.accent }}>{pillars[0].eyebrow}</span>
      <span className="mt-3 block w-14 h-[2px]" style={{ background: pillars[0].theme.accent }} />
      <h2 className={T.heading}>Sustainability in Every Decision</h2>
      <QuoteMark className="w-12 h-12 mt-8 mb-6" color={pillars[0].theme.accent} />
      <blockquote className={T.lead}>&ldquo;{pillars[0].body}&rdquo;</blockquote>
    ...
    <div key="p1" className="w-full shrink-0 flex flex-col justify-center px-14 xl:px-20 py-16" style={{ height: panelHeight, background: pillars[1].theme.tint }}>
      <span className={T.eyebrow} style={{ color: pillars[1].theme.accent }}>{pillars[1].eyebrow}</span>
      <span className="mt-3 block w-14 h-[2px]" style={{ background: pillars[1].theme.accent }} />
      <h3 className={T.heading}>{pillars[1].title}</h3>
      <QuoteMark className="w-12 h-12 mt-8 mb-6" color={pillars[1].theme.accent} />
      <blockquote className={T.lead}>&ldquo;{pillars[1].body}&rdquo;</blockquote>
      <div className="mt-7 grid grid-cols-3 gap-4 max-w-lg">
    ...
    <div key="p2" className="w-full shrink-0 flex flex-col justify-center px-14 xl:px-20 py-16" style={{ height: panelHeight, background: pillars[2].theme.tint }}>
      <span className={T.eyebrow} style={{ color: pillars[2].theme.accent }}>{pillars[2].eyebrow}</span>
      <span className="mt-3 block w-14 h-[2px]" style={{ background: pillars[2].theme.accent }} />
      <h3 className={T.heading}>{pillars[2].title}</h3>
      <QuoteMark className="w-12 h-12 mt-8 mb-6" color={pillars[2].theme.accent} />
      <blockquote className={T.lead}>&ldquo;{pillars[2].body}&rdquo;</blockquote>
      <div className="mt-7 grid grid-cols-3 gap-4 max-w-lg">
    ...
    <div key="p3" className="w-full shrink-0 flex flex-col justify-center px-14 xl:px-20 py-16" style={{ height: panelHeight, background: pillars[3].theme.tint }}>
      <span className={T.eyebrow} style={{ color: pillars[3].theme.accent }}>{pillars[3].eyebrow}</span>
      <span className="mt-3 block w-14 h-[2px]" style={{ background: pillars[3].theme.accent }} />
      <h3 className={T.heading}>{pillars[3].title}</h3>
      <QuoteMark className="w-12 h-12 mt-8 mb-6" color={pillars[3].theme.accent} />
      <blockquote className={T.lead}>&ldquo;{pillars[3].body}&rdquo;</blockquote>
      <div className="mt-7 grid grid-cols-3 gap-4 max-w-lg">
    ...
    <div key="p4" className="w-full shrink-0 flex flex-col justify-center px-14 xl:px-20 py-16" style={{ height: panelHeight, background: pillars[4].theme.tint }}>
      <span className={T.eyebrow} style={{ color: pillars[4].theme.accent }}>{pillars[4].eyebrow}</span>
      <span className="mt-3 block w-14 h-[2px]" style={{ background: pillars[4].theme.accent }} />
      <h3 className={T.heading}>{pillars[4].title}</h3>
      <QuoteMark className="w-12 h-12 mt-8 mb-6" color={pillars[4].theme.accent} />
      <blockquote className={T.lead}>&ldquo;{pillars[4].body}&rdquo;</blockquote>
      <div className="mt-7 grid grid-cols-3 gap-4 max-w-lg">
    ...
    <div key="d5" className="w-full shrink-0 flex flex-col justify-center px-14 xl:px-20 py-12" style={{ height: panelHeight, background: '#FAF9F6' }}>
      <span className={`${T.eyebrow} text-[#B37B29]`}>Impact in Action</span>
      <span className="mt-3 block w-14 h-[2px] bg-[#B37B29]" />
      <h3 className={T.heading}>Sustainability Projects</h3>
      ...
      <div className="mt-6 relative z-10">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <h4 className={T.subhead}>{projects[currentProjectIndex].title}</h4>
            <p className={`${T.body} max-w-xl`}>{projects[currentProjectIndex].desc}</p>
            <p className={`${T.meta} max-w-xl`}>{projects[currentProjectIndex].longDesc}</p>
            {projects[currentProjectIndex].hasVideo && (
              <div className="flex flex-wrap gap-3 pt-1">
                <button onClick={() => setIsVideoModalOpen(true)} className="inline-flex items-center gap-2 bg-green hover:bg-[#0E3B2A] text-white font-bold text-xs px-5 py-2.5 rounded-full transition-colors shadow-md">
      ...
      <div className="flex items-center justify-between mt-6 max-w-xl">
        <div className="flex gap-2">
          {projects.map((p, idx) => (
            <button key={p.id} onClick={() => setCurrentProjectIndex(idx)} className={`h-2.5 rounded-full transition-all duration-300 ${currentProjectIndex === idx ? 'w-8 bg-[#cc9933]' : 'w-2.5 bg-slate-300'}`} aria-label={`Project ${idx + 1}`} />
          ))}
        </div>
        <div className="flex gap-2">
    ...
    <div key="d6" className="w-full shrink-0 flex flex-col justify-center px-14 xl:px-20 py-12" style={{ height: panelHeight, background: '#F5F5F4' }}>
      <span className={`${T.eyebrow} text-green`}>Local Content</span>
      <span className="mt-3 block w-14 h-[2px] bg-green" />
      <h3 className={T.heading}>Local Content & Alliances</h3>
      ...
      <div className="mt-6 grid grid-cols-2 gap-3 max-w-2xl">
        {localContentItems.map((item, index) => (
          <div key={index} className="flex items-start gap-3 bg-white border border-slate-100 rounded-xl p-3 hover:border-green/30 transition-all">
            ...
            <span className={T.meta}>{item}</span>
          </div>
        ))}
      </div>

      <div className="mt-6 bg-gradient-to-br from-[#0E3B2A] to-slate-900 text-white rounded-2xl p-5 max-w-2xl relative overflow-hidden">
        <div className="relative z-10 space-y-2">
          <span className="text-[10px] font-bold text-green-light uppercase tracking-wider block">Human Rights Policy</span>
          <h4 className={`${T.subhead} text-white`}>Preserving Fundamental Rights & Dignity</h4>
      ...
      <div className="mt-6">{dotRow(6, '#0E3B2A')}</div>
    </div>,
    ...
    <div key="d7" className="w-full shrink-0 flex flex-col justify-center px-14 xl:px-20 py-12" style={{ height: panelHeight, background: '#ffffff' }}>
      <span className={`${T.eyebrow} text-green`}>Accreditation</span>
      <span className="mt-3 block w-14 h-[2px] bg-green" />
      <h3 className={T.heading}>Globally Recognized Standards</h3>
      ...
      <div className="mt-6 grid grid-cols-2 lg:grid-cols-4 gap-4 max-w-3xl">
        {[
          ...
          { title: 'Ghana Club 100', desc: '#1 Hospitality & Tourism — 2023', color: 'text-[#cc9933]' },
        ].map((card) => (
          <div key={card.title} className="bg-white border border-slate-100 rounded-2xl p-5 text-center hover:border-green/20 hover:shadow-lg transition-all duration-300">
            ...
            <h4 className={`${T.subhead} text-base mb-1`}>{card.title}</h4>
            <p className={T.meta}>{card.desc}</p>
          </div>
        ))}
      </div>
      ...
      <div className="mt-5 bg-white border border-slate-100 rounded-2xl p-5 flex items-center justify-between max-w-3xl shadow-sm">
        <div>
          <h4 className={T.subhead}>Ghana Club 100 Awards 2023</h4>
          <p className={T.meta}>1st in Hospitality & Tourism, 32nd overall</p>
        </div>
        <div className="text-center shrink-0">
          <span className="block font-outfit text-3xl xl:text-4xl font-semibold text-green tracking-tight">#1</span>
          <p className={T.statLabel}>Hospitality</p>
        </div>
      </div>
      <div className="mt-6">{dotRow(7, '#0E3B2A')}</div>
    </div>,
    ...
    <div key="close" className="w-full shrink-0 bg-white flex flex-col justify-center px-14 xl:px-20 py-14 relative overflow-hidden" style={{ height: panelHeight }}>
      ...
      <div className="relative z-10 max-w-xl">
        <span className={`${T.eyebrow} text-[#cc9933]`}>Our Promise</span>
        ...
        <div className="mt-9 grid grid-cols-3 gap-4 lg:gap-6 max-w-lg">
          {promiseStats.map((stat) => (
            <div key={stat.label} className="border-t border-[#1a1a1a]/15 pt-4">
              <p className={T.statValue}>{stat.value}</p>
        ...
        <div className="mt-10 max-w-xl">
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3">
            ...
            <p className={`${T.body} text-[#1a1a1a] font-semibold tracking-wide`}>
  ...
  return (
    <div>
      ...
      <section className="gsap-hero-trigger relative w-full px-6 md:px-12 pt-32 pb-24 md:pt-40 md:pb-32 overflow-hidden bg-[#FAF7EF] text-[#0d0d0d] transition-colors duration-300 min-h-[90vh] flex items-center justify-center">
        ...
        <div className="gsap-hero-dish-right absolute right-0 xl:-right-10 bottom-10 z-10 w-[260px] h-[260px] md:w-[400px] md:h-[400px] xl:w-[460px] xl:h-[460px] lg:opacity-100 pointer-events-none select-none hidden lg:block">
          <Image src="/assets/images/dishes/dish4.png" alt="Premium Culinary Roast" fill className="object-cover" />
        </div>

        <div className="max-w-4xl mx-auto text-center space-y-4 relative z-20">
          <span className="gsap-hero-sub text-[10px] md:text-sm font-bold text-[#cc9933] uppercase tracking-[0.35em] mb-2 block relative z-20">ISO 22000 · 14001 · 45001 Certified</span>
          <h1 className="gsap-hero-title font-extrabold uppercase leading-[1.1] tracking-tighter m-0 text-center">
            <span className="block overflow-hidden py-1">
              <span className="block text-[7.4vw] sm:text-[5.6vw] md:text-[4.3vw] lg:text-[5.4rem] tracking-[0.02em] text-[#0d0d0d]/70">Sustainably</span>
            </span>
            <span className="block overflow-hidden py-1">
              <span className="block text-[12vw] sm:text-[9vw] md:text-[7vw] lg:text-[8.7rem] text-transparent" style={{ WebkitTextStroke: '2px rgba(14,59,42,0.9)' }}>
                Serving <em className="not-italic text-[#cc9933]" style={{ WebkitTextStroke: '0px' }}>Ghana</em>
              </span>
            </span>
          </h1>
          <p className="gsap-hero-sub text-xs md:text-base leading-relaxed text-[#0d0d0d]/70 font-medium max-w-2xl mx-auto pt-6">
      ...
      <section ref={sectionRef} className={`relative w-full bg-white select-none ${useSplit ? 'lg:h-screen lg:overflow-hidden' : ''}`}>
        ...
        <div className={useSplit ? 'lg:hidden' : ''}>
          <div className="px-6 pt-16 pb-8">
            <span className="block text-[#cc9933] font-outfit text-xs font-semibold uppercase tracking-[0.28em]">Our Pillars</span>
            <span className="mt-3 block w-14 h-[2px] bg-[#cc9933]" />
            <h2 className="text-3xl sm:text-4xl font-semibold text-[#1a1a1a] font-outfit tracking-tight leading-[1.08] mt-4">Sustainability in Every Decision</h2>
          </div>

          {/* Pillar 0 */}
          <div className="relative overflow-hidden px-6 py-12" style={{ background: pillars[0].theme.solid }}>
            <span className="block font-outfit text-xs font-semibold uppercase tracking-[0.3em] text-white/90 mb-2">{pillars[0].eyebrow}</span>
            <h3 className="text-2xl font-semibold text-white font-outfit tracking-tight leading-snug mb-3">{pillars[0].title}</h3>
            <blockquote className="text-base font-normal leading-relaxed text-white/90">&ldquo;{pillars[0].body}&rdquo;</blockquote>
            <div className="mt-4 grid grid-cols-3 gap-3">
              {pillars[0].stats.map((s) => (
                <div key={s.label} className="border-t border-white/20 pt-3">
                  <p className="text-lg font-semibold font-outfit tracking-tight text-white">{s.value}</p>
          ...
          <div className="relative overflow-hidden px-6 py-12" style={{ background: pillars[1].theme.solid }}>
            <span className="block font-outfit text-xs font-semibold uppercase tracking-[0.3em] text-white/90 mb-2">{pillars[1].eyebrow}</span>
            <h3 className="text-2xl font-semibold text-white font-outfit tracking-tight leading-snug mb-3">{pillars[1].title}</h3>
            <blockquote className="text-base font-normal leading-relaxed text-white/90">&ldquo;{pillars[1].body}&rdquo;</blockquote>
            <div className="mt-4 grid grid-cols-3 gap-3">
              {pillars[1].stats.map((s) => (
                <div key={s.label} className="border-t border-white/20 pt-3">
                  <p className="text-lg font-semibold font-outfit tracking-tight text-white">{s.value}</p>
          ...
          <div className="relative overflow-hidden px-6 py-12" style={{ background: pillars[2].theme.solid }}>
            <span className="block font-outfit text-xs font-semibold uppercase tracking-[0.3em] text-white/90 mb-2">{pillars[2].eyebrow}</span>
            <h3 className="text-2xl font-semibold text-white font-outfit tracking-tight leading-snug mb-3">{pillars[2].title}</h3>
            <blockquote className="text-base font-normal leading-relaxed text-white/90">&ldquo;{pillars[2].body}&rdquo;</blockquote>
            <div className="mt-4 grid grid-cols-3 gap-3">
              {pillars[2].stats.map((s) => (
                <div key={s.label} className="border-t border-white/20 pt-3">
                  <p className="text-lg font-semibold font-outfit tracking-tight text-white">{s.value}</p>
          ...
          <div className="relative overflow-hidden px-6 py-12" style={{ background: pillars[3].theme.solid }}>
            <span className="block font-outfit text-xs font-semibold uppercase tracking-[0.3em] text-white/90 mb-2">{pillars[3].eyebrow}</span>
            <h3 className="text-2xl font-semibold text-white font-outfit tracking-tight leading-snug mb-3">{pillars[3].title}</h3>
            <blockquote className="text-base font-normal leading-relaxed text-white/90">&ldquo;{pillars[3].body}&rdquo;</blockquote>
            <div className="mt-4 grid grid-cols-3 gap-3">
              {pillars[3].stats.map((s) => (
                <div key={s.label} className="border-t border-white/20 pt-3">
                  <p className="text-lg font-semibold font-outfit tracking-tight text-white">{s.value}</p>
          ...
          <div className="relative overflow-hidden px-6 py-12" style={{ background: pillars[4].theme.solid }}>
            <span className="block font-outfit text-xs font-semibold uppercase tracking-[0.3em] text-white/90 mb-2">{pillars[4].eyebrow}</span>
            <h3 className="text-2xl font-semibold text-white font-outfit tracking-tight leading-snug mb-3">{pillars[4].title}</h3>
            <blockquote className="text-base font-normal leading-relaxed text-white/90">&ldquo;{pillars[4].body}&rdquo;</blockquote>
            <div className="mt-4 grid grid-cols-3 gap-3">
              {pillars[4].stats.map((s) => (
                <div key={s.label} className="border-t border-white/20 pt-3">
                  <p className="text-lg font-semibold font-outfit tracking-tight text-white">{s.value}</p>
          ...
          <div className="relative bg-[#FAF9F6] px-6 py-12">
            <span className="block font-outfit text-xs font-semibold uppercase tracking-[0.3em] text-[#B37B29] mb-2">Impact in Action</span>
            <h3 className="text-2xl font-semibold text-[#1a1a1a] font-outfit tracking-tight leading-snug mb-6">Sustainability Projects</h3>
            <AnimatePresence mode="wait">
          ...
          <div className="relative bg-[#F5F5F4] px-6 py-12">
            <span className="block font-outfit text-xs font-semibold uppercase tracking-[0.3em] text-green mb-2">Local Content</span>
            <h3 className="text-2xl font-semibold text-[#1a1a1a] font-outfit tracking-tight leading-snug mb-6">Local Content & Alliances</h3>
            ...
            <div className="mt-6 bg-gradient-to-br from-[#0E3B2A] to-slate-900 text-white rounded-2xl p-5 relative overflow-hidden">
              <div className="space-y-2">
                <span className="text-[10px] font-bold text-green-light uppercase tracking-wider block">Human Rights Policy</span>
                <h4 className={`${T.subhead} text-white`}>Preserving Fundamental Rights & Dignity</h4>
                <p className={`${T.body} text-white/80`}>Our commitment to human rights is embedded in Atlantic&apos;s Human Rights Policy, aligned with globally acknowledged principles across all assets.</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative bg-white px-6 py-12">
            <span className="block font-outfit text-xs font-semibold uppercase tracking-[0.3em] text-green mb-2">Accreditation</span>
            <h3 className="text-2xl font-semibold text-[#1a1a1a] font-outfit tracking-tight leading-snug mb-6">Globally Recognized Standards</h3>
          ...
          <div className="relative bg-white px-6 py-14 overflow-hidden">
            ...
            <div className="relative z-10 max-w-xl">
              <span className={`${T.eyebrow} text-[#cc9933]`}>Our Promise</span>
              <h3 className="text-3xl font-semibold text-[#1a1a1a] font-outfit mt-4 leading-[1.05]">Hospitality without compromise.</h3>
              ...
              <div className="mt-9 grid grid-cols-3 gap-4 max-w-lg">
                {promiseStats.map((stat) => (
                  <div key={stat.label} className="border-t border-[#1a1a1a]/15 pt-4">
                    <p className="text-lg font-semibold text-[#1a1a1a] font-outfit tracking-tight">{stat.value}</p>
                    <p className={T.statLabel}>{stat.label}</p>
                  </div>
                ))}
              </div>
